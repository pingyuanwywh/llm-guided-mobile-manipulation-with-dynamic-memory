#!/usr/bin/env bash
# 2026-08-15 drone5 six-view composite with corrected detections.
set -euo pipefail
...
RVIZ="$D/edited/20260815_2120_drone5_2station-5can-SUCCESS-5of5/intermediate/20260815_2120_drone5_dynamic_rviz_corrected_full.mp4"; RVIZ_SS=13.500
...
FULL="$OUTDIR/20260815_2120_drone5_2station-5can_6view_v3_corrected_full.mp4"
HILITE="$OUTDIR/20260815_2120_drone5_2station-5can_6view_v3_corrected_highlight75s.mp4"
