#!/usr/bin/env bash
# 2026-08-08 scene3 two-station five-can closed-loop demo, five-view composite.
# Layout: top row 2 views, bottom row 3 views, no title bar.
# This scene uses the rendered RVIZ/godview video from edited/.

set -euo pipefail

D=$HOME/jetrover_demo
R="$D/raw/20260808_2115_scene3_2station-5can-closedloop"
FONT=/usr/share/fonts/opentype/noto/NotoSerifCJK-Bold.ttc
MODE="${1:-full}"

CEIL="$R/WIN_20260808_21_14_03_Pro.mp4";       CEIL_SS=101.365
PHONE="$R/VID_20260808_211354.mp4";            PHONE_SS=110.365
RGB="$R/20260808_211544_scene3_rgb.mp4";       CAR_SS=0.000
DEPTH="$R/20260808_211544_scene3_depth.mp4"
RVIZ="$D/edited/20260808_2115_scene3_2station-5can-closedloop/intermediate/20260808_2115_scene3_godview_annotated.mp4"; RVIZ_SS=0.000

# RGB/depth end at 407.533s in frames.csv; use the common overlap.
DUR=407.533
TARGET_HIGHLIGHT=75
SPEED_PTS=0.184034

OUTDIR="$D/edited/20260808_2115_scene3_2station-5can-closedloop/final"
FULL="$OUTDIR/20260808_2115_scene3_2station-5can_5view_full.mp4"
HILITE="$OUTDIR/20260808_2115_scene3_2station-5can_5view_highlight75s.mp4"
